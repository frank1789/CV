...
\BLOCK{ for c in certificate|sort(attribute='month', reverse = True)|sort(attribute='year', reverse = True) }
\BLOCK{ if c["link"] != None }
    \entrycertificate{\VAR{'%02d' % c["month"]}}{\VAR{c["year"]}}{\href{\VAR{c["link"]}}{\VAR{c["subject"]}}}{\VAR{c["entity"]}}
\BLOCK{else}
    \entrycertificate{\VAR{'%02d' % c["month"]}}{\VAR{c["year"]}}{\VAR{c["subject"]}}{\VAR{c["entity"]}}
\BLOCK{ endif }
\BLOCK{ endfor }
