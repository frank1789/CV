...
\section{skills}
	\begin{entrylist} 
		\entryskills{\textbf{Programming}}{C++,  C, Qt, Python, Ruby, R, \LaTeX{}}
		
		\entryskills{\textbf{Software}}{Microsoft Office, Visual Studio Code}\\
		
		\entryskills{\textbf{Package}}{Matlab \& Simulink, Maple, Ansys, SolidWorks, HyperWorks}
		
		\entryskills{\textbf{Other}}{Internet networking, Arduino, Raspberry Pi}\\
		
		\entryskills{\textbf{OS}}{MacOS, Linux, Windows}
	\end{entrylist}
